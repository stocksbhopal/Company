...
public class IntentUtils {
    ...
    public static CompanyOrSymbol getCompanyOrSymbol(IntentRequest request) {
    	String symbol = null;
    	String companyOrSymbol = null;
    	
    	Intent intent = request.getIntent();
    	if (intent.getSlot(InterfaceIntent.SLOT_COMPANY) != null && intent.getSlot(InterfaceIntent.SLOT_COMPANY).getValue().trim().length() > 0) {
    		companyOrSymbol = intent.getSlot(InterfaceIntent.SLOT_COMPANY).getValue();
    	}
    	else {
    		if (intent.getSlot(InterfaceIntent.SLOT_SPELLING_SIX) != null && intent.getSlot(InterfaceIntent.SLOT_SPELLING_SIX).getValue().trim().length() > 0) {
    		...
    		if (intent.getSlot(InterfaceIntent.SLOT_SPELLING_FIVE) != null && intent.getSlot(InterfaceIntent.SLOT_SPELLING_FIVE).getValue().trim().length() > 0) {
    		...
    		if (intent.getSlot(InterfaceIntent.SLOT_SPELLING_FOUR) != null && intent.getSlot(InterfaceIntent.SLOT_SPELLING_FOUR).getValue().trim().length() > 0) {
    		...
    		if (intent.getSlot(InterfaceIntent.SLOT_SPELLING_THREE) != null && intent.getSlot(InterfaceIntent.SLOT_SPELLING_THREE).getValue().trim().length() > 0) {
    		...
    		if (intent.getSlot(InterfaceIntent.SLOT_SPELLING_TWO) != null && intent.getSlot(InterfaceIntent.SLOT_SPELLING_TWO).getValue().trim().length() > 0) {
    		...
    		if (intent.getSlot(InterfaceIntent.SLOT_SPELLING_ONE) != null && intent.getSlot(InterfaceIntent.SLOT_SPELLING_ONE).getValue().trim().length() > 0) {
